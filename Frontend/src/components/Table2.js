  ...
  return (
    <div className="countries_stat" id="countries_stat">
        ...
        {Data.map(({country_name,cases,deaths,total_recovered})=>
         ...
         <th className="table-country">{country_name}</th>
         <th className="table-confirmed">{cases}</th>
         <th className="table-recovered">{deaths}</th>
         <th className="table-deaths">{total_recovered}</th>
         </tr>
            )}
